...
-- Note elapsed time
--
alter table emp move compress for query low;
...
--
-- Compress the table for archive high
--
-- Note elapsed time to compress
--
alter table emp move compress for archive high;
...
-- Note elapsed time
--
alter table emp move compress for archive low;
